...
-->  
  ...
  <xsl:variable name="flattened_structure" static="no">
    <xsl:choose>
  ...
  -->
  <xsl:variable name="flattened_structure_with_separators" static="no">
  ...
  -->
  <xsl:variable name="grouped_structure" static="no">
  ...
  -->
  <xsl:variable name="grouped_structure_resolved_pointers" static="no">
